...
fn test_add_sub() {
    ...
    let third = Dim::new(17.3, &MILLIMETRE);
...
#[test]
fn convert() {
    let mut val = Dim::new(24.0, &KILOMETRE);
...
#[test]
fn check_borrow() {
    let mut val = Dim::new(125.0, &CENTIMETRE);
    let val2 = val.clone();
    borrow(&mut val, &val2);
